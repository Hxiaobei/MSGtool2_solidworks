...
Public Class ProPackMain
    ...
    Private Sub LoadModel(ByVal swModel As ModelDoc2)
        ...
        curItem.SubItems.Add(swModel.CustomInfo2("", "零件类型")) '零件类型
        curItem.SubItems.Add(FileName)
        curItem.SubItems.Item(1).Tag = FilePath
        curItem.SubItems.Item(3).Tag = FileName
        ...
        If IsNothing(swComps) = False Then
            ...
            For i = 0 To UBound(swComps)
                ...
                If myComDict.ContainsKey(compPath) = False Then
                    ...
                    Dim comModel As ModelDoc2
                    comModel = curComP.GetModelDoc2

                    Dim t As String
                    t = ""
                    If Not comModel Is Nothing Then

                        t = comModel.CustomInfo2("", "零件类型")
                    End If

                    curItem.SubItems.Add(t) '零件类型
    ...
    Private Sub Button3_Click(sender As System.Object, e As System.EventArgs) Handles Button3.Click
        ...
        For i = 0 To TreeItemList.Count - 1
            ...
            Dim RdisPath As String

            If curTreeItem.SubItems.Item(2).Text <> "" Then

                rdisPath = disPath & curTreeItem.SubItems.Item(2).Text & "\"

                If My.Computer.FileSystem.DirectoryExists(rdisPath) = False Then
                    My.Computer.FileSystem.CreateDirectory(rdisPath)
                End If
            Else
                rdisPath = disPath
            End If
             
            np = rdisPath & curTreeItem.SubItems.Item(3).Text
            SetMsg("开始复制文件：" & rp)
            ...
            CopyExt(CheckBox1.Checked, rp, ".slddrw", RdisPath) 'CopyExt(CheckBox1.Checked, rp,CheckBox1.text, disPath)
            CopyExt(CheckBox2.Checked, rp, ".dwg", RdisPath)
            CopyExt(CheckBox2.Checked, rp, ".pdf", RdisPath)
        ...
        For n = 0 To modelT.Count - 1
            ...
            If curTreeLitem.SubItems.Item(2).Text <> "" Then

                RdisPath = disPath & curTreeLitem.SubItems.Item(2).Text & "\"
            ...
            ReferencingDocument = RdisPath & curTreeLitem.SubItems.Item(3).Text
            ...
            For n1 = 0 To modelT1.Count - 1
                ...
                Dim RdisPath1 As String

                If curTreeLitem1.SubItems.Item(2).Text <> "" Then

                    RdisPath1 = disPath & curTreeLitem1.SubItems.Item(2).Text & "\"
 
                Else
                    RdisPath1 = disPath
                End If

                NewReference = RdisPath1 & curTreeLitem1.SubItems.Item(3).Text
        ...
        If CheckBox1.Checked = False Then
            For i = 0 To TreeItemList.Count - 1
                ...
                If curTreeLitem.SubItems.Item(2).Text <> "" Then
                    ...
                    RdisPath1 = disPath & curTreeLitem.SubItems.Item(2).Text & "\"
                ...
                NewReferenceDocument = RdisPath1 & curTreeLitem.SubItems.Item(3).Text '新的模型的路径

                Dim NewSlddrwPath As String
                NewSlddrwPath = RdisPath1 & Path.GetFileNameWithoutExtension(NewReferenceDocument) & ".slddrw"
    ...
    Private Sub Button6_Click(sender As System.Object, e As System.EventArgs) Handles Button6.Click
        ...
        For n = 0 To modelT.Count - 1
            ...
            curTreeLitem.SubItems.Item(3).Text = TextBox2.Text & curTreeLitem.SubItems.Item(3).Text
    ...
    Private Sub Button7_Click(sender As System.Object, e As System.EventArgs) Handles Button7.Click
        ...
        For n = 0 To modelT.Count - 1
            ...
            tt = Split(curTreeLitem.SubItems.Item(3).Text, ".")
            ...
            curTreeLitem.SubItems.Item(3).Text = Join(tt, ".") & TextBox3.Text & "." & t1
    ...
    Private Sub Button8_Click(sender As System.Object, e As System.EventArgs) Handles Button8.Click
        ...
        For n = 0 To modelT.Count - 1
            ...
            curTreeLitem.SubItems.Item(3).Text = Replace(Join(tt, "."), TextBox5.Text, TextBox4.Text) & "." & t1
